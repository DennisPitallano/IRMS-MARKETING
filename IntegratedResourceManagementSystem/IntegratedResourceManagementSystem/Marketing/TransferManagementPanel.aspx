            ...
            <ContentTemplate>
                          ...
                          <asp:Button ID="btnAddNew" CssClass="btnNew" runat="server" Text="NEW" />
                            ...
                            <asp:Panel ID="pnlAddOption" runat="server">
                                ...
                                <div class="hover-menu">
                                    <div class="new-link">
                                        <a href="NewTransfer.aspx" style="text-decoration: none;">STOCK TRANSFER
                                        </a>
                                    </div>
                                    <div class="new-link">
                ...
                <asp:Panel ID="pnlPullOutLetterModal" runat="server" CssClass="modal">
                        ...
                        <div style="text-align: center; margin: 5px;">
                            <asp:HyperLink ID="hpLinkUseSelectedPullOutLetter" Height="18px" Width="110px" style="line-height:18px;" CssClass="modalWarningButtonYes" runat="server">USE SELECTED</asp:HyperLink>
