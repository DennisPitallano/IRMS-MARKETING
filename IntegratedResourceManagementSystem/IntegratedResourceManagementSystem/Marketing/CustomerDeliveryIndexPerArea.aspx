<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true"
	CodeBehind="CustomerDeliveryIndexPerArea.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.CustomerDeliveryIndexPerArea" %>
		...
		<ContentTemplate>
			<div id="Dennis" style="height: 26px; margin-bottom: 1px;" class="modalDrag">
				<div style="float: left;">
					<div style="float: left; margin-right: 1px;">
						<asp:Label ID="lblCustomerLabel" runat="server" Text="AREA/SUB-AREA:" Font-Names="Verdana"
							Font-Size="12px" ForeColor="#FFFF99"></asp:Label>
						<asp:TextBox ID="txtAreaSubArea" runat="server" Width="270px" Font-Size="11px" CssClass="modalText"
						...
						<asp:MultiView ID="mviewAsOfDateOption" runat="server" ActiveViewIndex="1">
							...
							<asp:View ID="vDateForDay" runat="server">
								<label style="font-family: Verdana; font-size: 10px;" for="MainContent_txtDate">
									FROM:</label>
								<asp:TextBox ID="txtDate" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="12px"
									ForeColor="#996633" Height="18px"></asp:TextBox>
								...
								<asp:TextBox ID="txtDateTo" runat="server" Font-Bold="True" Font-Names="Verdana"
									Font-Size="12px" ForeColor="#996633" Height="18px"></asp:TextBox>
			...
			<div style="min-height: 390px;">
				...
				<asp:GridView ID="gvCDIList" runat="server" AllowPaging="True" AllowSorting="True"
					...
					<Columns>
						...
						<asp:BoundField DataField="DeliveredTo" HeaderText="OUTLET/CUSTOMER" SortExpression="DeliveredTo" />
					...
					<EmptyDataTemplate>
						<img alt="" src="../Resources/unhappy.png" align="middle" />
						EMPTY RESULT!!!
					</EmptyDataTemplate>
				...
				<asp:SqlDataSource ID="SqlDataSourceCDI" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
					SelectCommand="SP_GET_CDI_PER_AREA" EnableCaching="True" ViewStateMode="Disabled"
					SelectCommandType="StoredProcedure">
					<SelectParameters>
						<asp:ControlParameter ControlID="hfDateFrom" Name="DATE_FROM" PropertyName="Value"
							DbType="Date" />
						<asp:ControlParameter ControlID="hfDateTo" Name="DATE_TO" PropertyName="Value" DbType="Date" />
						<asp:ControlParameter ControlID="hfAreaGroupNumber" Name="AREA_GROUP_NUMBER" PropertyName="Value"
							Type="Int32" />
						<asp:ControlParameter ControlID="hfSubAreaGroupNumber" Name="SUB_AREA_GROUP_NUMBER" PropertyName="Value"
							Type="Int32" />
						<asp:ControlParameter ControlID="hfBrandName" Name="BRAND_NAME" PropertyName="Value"
							Type="String" />
					</SelectParameters>
				</asp:SqlDataSource>
			</div>
			<asp:Panel ID="pnlCustomersModal" runat="server" CssClass="modal">
				...
				<div style="height: 30px;">
					<div class="SeachBoxContainer" style="float: left; font-size:12px; font-weight:bold;">
						<asp:RadioButtonList ID="rdioType" runat="server" RepeatDirection="Horizontal" AutoPostBack="True"
							OnSelectedIndexChanged="rdioType_SelectedIndexChanged">
							<asp:ListItem Selected="True">AREA</asp:ListItem>
							<asp:ListItem>SUB-AREA</asp:ListItem>
						</asp:RadioButtonList>
					</div>
				</div>
				<div class="group-area" style="padding: 5px 5px; width:200px;">
					<div>
						AREA GROUP
					</div>
					<asp:DropDownList ID="DDLAreaGroup" Height="20px" CssClass="modalText" runat="server" AutoPostBack="True" 
						onselectedindexchanged="DDLAreaGroup_SelectedIndexChanged">
					</asp:DropDownList>
				</div>
				<asp:Panel ID="pnlSubArea" Visible="false" runat="server">
					<div class="group-area" style="padding: 5px 5px; width:200px;">
						<div>
							SUB-AREA GROUP
						</div>
						<asp:DropDownList Height="20px" CssClass="modalText" ID="DDLSubArea" runat="server">
						</asp:DropDownList>
					</div>
				</asp:Panel>
				...
				<div class="group-area" style="padding: 5px 5px; width:200px;">
					...
					<asp:DropDownList Height="20px" CssClass="modalText" ID="DDLBrands" runat="server">
					</asp:DropDownList>
			    </div>
				
				<div style="text-align: center; padding: 3px 0;">
					<asp:Button ID="btnSelectCustomer" CssClass="modalWarningButtonYes" runat="server"
						Text="OK"  OnClick="btnSelectCustomer_Click"  />
				</div>
			</asp:Panel>
			<asp:HiddenField ID="hfAreaGroupNumber" runat="server" />
			<asp:HiddenField ID="hfSubAreaGroupNumber" runat="server" />
			<asp:HiddenField ID="hfBrandName" Value="ALL" runat="server" />
