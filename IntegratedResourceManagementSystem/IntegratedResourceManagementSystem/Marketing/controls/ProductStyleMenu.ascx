...
<div style="float: left; width: 100px; margin-right: 5px;">
    <div class="mnuIcon">
        ...
        <asp:LinkButton ID="lnkProductItem" runat="server" CssClass="lblMenu" Font-Names="Verdana"
            Font-Size="10px" ForeColor="#A65300" ToolTip="Manage Items" Font-Bold="True"
            PostBackUrl="~/Marketing/ProductManagementPanel.aspx">MANAGE STYLES</asp:LinkButton>
    </div>
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkBtnGenericStylePanel" ForeColor="#A65300" runat="server" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Items" Font-Bold="True"
            PostBackUrl="~/Marketing/GenericStylesManagementPanel.aspx">GENERIC STYLES</asp:LinkButton>
    </div>
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkBrands" ForeColor="#A65300" runat="server" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Brands" Font-Bold="True"
    ...
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkCategories" ForeColor="#A65300" runat="server" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Product Brands" Font-Bold="True"
    ...
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkFabrics" runat="server" ForeColor="#A65300" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Fabric Categories" Font-Bold="True"
...
<div style="float: left; width: 100px; margin-right: 5px;">
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkGarments" runat="server" ForeColor="#A65300" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Garments" Font-Bold="True"
    ...
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkColors" ForeColor="#A65300" runat="server" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Colors" Font-Bold="True"
    ...
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="lnkSizes" runat="server" ForeColor="#A65300" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Product Sizes" Font-Bold="True"
    ...
    <div class="mnuIcon">
        ...
        <br />
        <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#A65300" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Fittings" Font-Bold="True"
            PostBackUrl="~/Marketing/FittingsManagementPanel.aspx"> MANAGE FITTINGS</asp:LinkButton>
    </div>
    <div class="mnuIcon">
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Resources/Uptighticon32.png"
            ToolTip="Manage Fabric Suppliers" PostBackUrl="~/Marketing/FabricSupplierManagementPanel.aspx" />
        <br />
        <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="#A65300" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="10px" ToolTip="Manage Fabric Suppliers" Font-Bold="True"
            PostBackUrl="~/Marketing/FabricSupplierManagementPanel.aspx">FABRIC SUPPLIERS</asp:LinkButton>
    </div>
</div>
<div style="float: left; width: 100px; margin-right: 5px;">
    <div class="mnuIcon">
    ...
    <div class="mnuIcon">
        ...
        <asp:LinkButton ForeColor="#A65300" ID="lnkPriceCheckAndItemReprocess" runat="server"
            CssClass="lblMenu" Font-Names="Verdana" Font-Size="9px" title="Check Price" Font-Bold="True"
            PostBackUrl="~/Marketing/PriceCheckingAndItemReprocessingPanel.aspx">PRCE CHECK</asp:LinkButton>
    </div>
    <div class="mnuIcon">
        <div>
            <asp:ImageButton ID="imgBtnItemReclassification" runat="server" ImageUrl="~/Resources/garments.png"
                Height="24px" Width="28px" title="Reclassify Items/Styles" PostBackUrl="~/Marketing/ReprocessItems.aspx" />
        </div>
        <asp:LinkButton ID="lnkBtnItemReclassification" ForeColor="#A65300" runat="server"
            CssClass="lblMenu" Font-Names="Verdana" Font-Size="9px" title="Reclassify Items/Styles"
            Font-Bold="True" PostBackUrl="~/Marketing/ReprocessItems.aspx">ITEM RECLASSI-FICATION</asp:LinkButton>
    </div>
    <div class="mnuIcon">
        <div>
            <asp:ImageButton ID="imgStockInputReport" runat="server" ImageUrl="~/Resources/adjustment.png"
                Height="34px" title="Stock Input Report Generator" PostBackUrl="~/Marketing/StockInputReport.aspx" />
        </div>
        <asp:LinkButton ID="lnkStockInputReport" runat="server" ForeColor="#A65300" CssClass="lblMenu"
            Font-Names="Verdana" Font-Size="9px" title="Stock Input Report Generator" Font-Bold="True"
