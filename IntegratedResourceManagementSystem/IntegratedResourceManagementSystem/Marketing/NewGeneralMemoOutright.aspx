<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true"
    CodeBehind="NewGeneralMemoOutright.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.NewGeneralMemoOutright" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="../Styles/new-general-memo-outright.css" rel="stylesheet" type="text/css" />
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="height: 22px; margin-bottom: 10px; line-height: 22px; font-family: Verdana;
        ...
        <asp:Image ID="imgpnlTitle" runat="server" ImageUrl="~/Resources/memo-doc.png" ImageAlign="Top"
            Height="22px" />
        &nbsp;NEW GENERAL MEMO(OUTRIGHT)
        <div style="float: right; height: 20px;">
        <a href="GeneralMemoOutright.aspx" title="Back to General Memo Concession">
        ...
        <ContentTemplate>
                    ...
                    <asp:MultiView ID="mvApplyPricePoint" ActiveViewIndex="0" runat="server">
                        <asp:View ID="vAreaGroup" runat="server">
                            ...
                            <asp:Panel ID="pnlSubAreaGroup" Visible="false" runat="server">
                                <label class="frmLabel" for="MainContent_txtPromoPeriodFrom">
                                    PROMO PERIOD FROM:
                                    <asp:TextBox ID="txtPromoPeriodFrom" Height="20px" CssClass="modalText" runat="server"></asp:TextBox></label>
                                <asp:CalendarExtender ID="txtPromoPeriodFrom_CalendarExtender" runat="server" Enabled="True"
                                    TargetControlID="txtPromoPeriodFrom">
                                </asp:CalendarExtender>
                                <label class="frmLabel">
                                    TO
            ...
            <div style="text-align:center;">
                <div style="display: inline-block; margin-left: 5px;">
                 ...
                 <div style="display: inline-block; margin-left: 5px;">
                   <a href="GeneralMemoOutright.aspx">
