<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true"
    CodeBehind="NewPullOutLetter.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.NewPullOutLetter" %>
        ...
        <ContentTemplate>
            <div class="titleList" style="width: 750px;">
                ...
                <div style="float: right;">
                    <asp:Button ID="btnUpdateForwarder" Enabled="false" CssClass="btnAddForwarderDisAble"
                        runat="server" Text="forwarder" />
                                ...
                                <asp:GridView ID="gvSelectedStyles" CssClass="table_grid" runat="server" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <HeaderTemplate>
                                                <asp:CheckBox ID="chkAllSelected" runat="server" title="Select All" ClientIDMode="Static"
                                                    onclick="SelectAll('MainContent_gvSelectedStyles','chkAllSelected')" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkItems" runat="server" />
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="ContainerNumber" HeaderText="BOX#">
                                            ...
                                            <ItemStyle Font-Bold="True" ForeColor="Maroon" HorizontalAlign="Center" Width="20px" />
                                        </asp:BoundField>
                                    </Columns>
                                    <EditRowStyle BackColor="#7C6F57" />
                                    <EmptyDataTemplate>
