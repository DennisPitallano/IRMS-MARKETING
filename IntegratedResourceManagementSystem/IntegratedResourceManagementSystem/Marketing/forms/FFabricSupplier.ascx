<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FFabricSupplier.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.forms.FFabricSupplier" %>
  <style type ="text/css">
    .frmbg
    {
