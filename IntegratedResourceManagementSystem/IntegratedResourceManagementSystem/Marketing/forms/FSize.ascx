<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FSize.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.forms.FSize" %>
...
<table  style="width: 100%;">
  <tr>
    ...
    <td>
      <asp:TextBox ID="txtSizeCode" runat="server" Height="20px"  CssClass="modalText" Width ="150px"></asp:TextBox>
    </td>
    <td>
      &nbsp;
    </td>
  ...
  <tr>
    ...
    <td>
      <asp:TextBox ID="txtSizeDescription" runat="server" Height="40px" 
                   TextMode="MultiLine"  CssClass="modalText"  Width ="150px"></asp:TextBox>
        <asp:HiddenField ID="hfID" runat="server" Value ="0" />
        <asp:HiddenField ID="hfDisplay" runat="server" Value ="0" />
        <asp:HiddenField ID="hfSizeGroup" runat="server" Value ="0" />
    </td>
    <td>
      &nbsp;
    </td>
