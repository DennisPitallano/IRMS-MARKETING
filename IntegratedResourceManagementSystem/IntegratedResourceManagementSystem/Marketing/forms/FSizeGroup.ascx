<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FSizeGroup.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.forms.FSizeGroup" %>
...
<table class ="frmbg" style="width: 100%;">
  <tr>
    ...
    <td>
      <asp:TextBox ID="txtSizeGroupName" runat="server" Height="20px" 
