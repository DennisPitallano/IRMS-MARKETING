<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FSubFitting.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.forms.FSubFitting" %>
  <style type ="text/css">
    .frmbg
    {
    ...
    <table  style="width: 100%;">
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtSubFitting" runat="server" Height="40px" Width="250px"  
                CssClass="modalText" EnableViewState="False" TextMode="MultiLine"></asp:TextBox>
      ...
      <tr>
        ...
        <td>
            <asp:DropDownList ID="DDLFittings" CssClass="modalText" Height="22px" runat="server">
            </asp:DropDownList>
          </td>
        <td>
          &nbsp;
