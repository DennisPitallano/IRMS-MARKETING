<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FFabric.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.forms.FFabric" %>
...
<style type ="text/css" >
 ...
 <table class="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtFabricCode" runat="server" CssClass ="modalText" Height="20px"></asp:TextBox>
        </td>
        <td>
          &nbsp;
        </td>
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtFabricDescription" runat="server" Height="40px" 
