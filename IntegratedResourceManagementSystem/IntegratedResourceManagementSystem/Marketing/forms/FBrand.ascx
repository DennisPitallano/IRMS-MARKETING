   ...
   .patern
    {
        ...
        border-radius:0px 10px 10px 10px; 
         text-shadow: 1px 0px 1px #E0E0E0;
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtBrandDescription" runat="server" Height="40px" 
                ...
                Width ="170px" EnableViewState="False"></asp:TextBox>
        </td>
        <td>
          &nbsp;
        </td>
      ...
      <tr>
        <td class ="modalLabel">
            START SERIES:</td>
        <td>
            <asp:TextBox ID="txtStartSeries" runat="server" Height="20px" Width ="50px" 
                CssClass ="modalText" EnableViewState="False"></asp:TextBox>
          <span class="patern">(NUMERIC INPUT [1-9])</span>
