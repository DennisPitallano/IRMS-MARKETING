<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FGarment.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.forms.FGarment" %>
 ...
 <table class ="frmbg" style="width: 100%;">
        <tr>
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox ID="txtGarmentCode" runat="server" Height="20px"  CssClass="modalText"></asp:TextBox>
              </td>
              <td>
                  &nbsp;
              </td>
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox ID="txtGarmentDescription" runat="server" Height="40px" 
