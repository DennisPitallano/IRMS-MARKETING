<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing-Admin/Admin.Master"
    AutoEventWireup="true" CodeBehind="TermManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.TermManagementPanel" %>

<%@ Register Src="~/Marketing/Marketing-Admin/controls/AdminMenu.ascx" TagName="menu"
    TagPrefix="irms" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/Marketing/controls/UCLoader.ascx" TagName="LOADER" TagPrefix="UC" %>
<%@ Register TagPrefix="forms" TagName="Term" Src="~/Marketing/Marketing-Admin/forms/TermForm.ascx" %>
<%@ Register TagPrefix="irms" TagName="ErrorMessgeBox" Src="~/Marketing/Marketing-Admin/controls/ErrorMessageBox.ascx" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/term-management.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="height:28px; margin-bottom:10px; line-height:28px; color: #333;text-shadow: 1px 1px 0px white;">
        ...
        &nbsp;<asp:Label ID="Label1" runat="server" Text="TERM MANAGEMENT PANEL" Font-Bold="True"
    ...
    <asp:UpdatePanel ID="upnlBrands" runat="server">
        <ContentTemplate>
            <div style="height: 26px; margin-bottom: 1px;" class="modalDrag">
                ...
                SEARCH:
                    <asp:TextBox ID="txtSearch" runat="server" autofocus placeholder="Search Term" CssClass="modalText" OnTextChanged="txtSearch_TextChanged"
                        AutoPostBack="True" Height="16px" Font-Size="10px" Width="150px" ToolTip="Search Term"></asp:TextBox>
            ...
            <div class="listContent">
                ...
                <asp:Panel ID="pnlDepartment" runat="server" Width="370px" Height="415px" ScrollBars="Auto">
                    <asp:GridView ID="gvTermsList" runat="server" CellPadding="4" GridLines="None" AutoGenerateColumns="False"
                        CssClass="table_grid" AllowPaging="True" AllowSorting="True" DataKeyNames="ID"
                        DataSourceID="SqlDataSourceTerms" EnablePersistedSelection="True" PageSize="15"
                        OnSelectedIndexChanged="gvTermsList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ListDesc" HeaderText="TERM DESCRIPTION" SortExpression="ListDesc">
                            </asp:BoundField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceTerms" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                        SelectCommand="SELECT [ID], [ListDesc] FROM [lstTerms] ORDER BY [ID] DESC"></asp:SqlDataSource>
                </asp:Panel>
            </div>
            <asp:Panel ID="pnlNewSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phTermForm" runat="server">
                    <forms:Term ID="fTerm" runat="server" />
                </asp:PlaceHolder>
                <div style="text-align: center; margin: 5px 0px;">
                    <asp:Button ID="btnSaveTerm" runat="server" CssClass="btnSave" Text="SAVE" ToolTip="Save New Term"
                        OnClick="btnSaveTerm_Click" />
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlUpdateSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phTermUpdate" runat="server">
                    <forms:Term ID="fTerm_Update" runat="server" />
                </asp:PlaceHolder>
                ...
                <div style="text-align: center; margin: 5px 0px;">
                    <asp:Button ID="btnSaveUpdate" runat="server" CssClass="btnSave" Text="SAVE" ToolTip="Update Term"
