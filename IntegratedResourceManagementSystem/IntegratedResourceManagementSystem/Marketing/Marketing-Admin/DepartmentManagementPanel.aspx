<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing-Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DepartmentManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.DepartmentManagementPanel" %>
<%@ Register  Src="~/Marketing/Marketing-Admin/controls/AdminMenu.ascx" TagName="menu" TagPrefix="irms" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/Marketing/controls/UCLoader.ascx" TagName="LOADER" TagPrefix="UC" %>
<%@ Register TagPrefix="forms" TagName="Department"  Src="~/Marketing/Marketing-Admin/forms/DepartmentForm.ascx" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/deparment-management.css" rel="stylesheet" type="text/css" />
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <irms:menu ID="admin_menu" runat="server" />
        ...
        <div style="height:28px; margin-bottom:10px; line-height:28px; color: #333;text-shadow: 1px 1px 0px white;">
                ...
                &nbsp;<asp:Label ID="Label1" runat="server" Text="DEPARTMENT MANAGEMENT PANEL" Font-Bold="True"
    ...
    <asp:UpdatePanel ID="upnlBrands" runat="server">
        <ContentTemplate>
            ...
            <div style="height:26px; margin-bottom:1px; " class="modalDrag">
                ...
                SEARCH:
                    <asp:TextBox ID="txtSearch" runat="server" autofocus placeholder="Search Department" CssClass="modalText" OnTextChanged="txtSearch_TextChanged"
                ...
                <div style="float: left;">
                    ...
                    <div style="float: left; margin-right: 5px;">
                    <a style="text-decoration:none;" href="Reports/Departments.aspx" target="_blank" >
            ...
            <div class="listContent">
                ...
                <asp:Panel ID="pnlDepartment" runat="server" Width="450px" Height="415px" ScrollBars="Auto">
                    <asp:GridView ID="gvDepartmentList" runat="server" CellPadding="4" 
                        GridLines="None" AutoGenerateColumns="False" CssClass="table_grid"
                       AllowPaging="True"
                        AllowSorting="True" DataKeyNames="ID" DataSourceID="SqlDataSourceDepartments"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ListDesc" HeaderText="DEPARTMENT NAME" SortExpression="ListDesc">
                            </asp:BoundField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceDepartments" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                        SelectCommand="SELECT [ID], [ListDesc] FROM [lstDept] ORDER BY [ID] DESC">
                    </asp:SqlDataSource>
                </asp:Panel>
            </div>
            ...
            <asp:Panel ID="pnlNewSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phDepartmentForm" runat="server">
                    <forms:Department ID="fDepartment" runat="server"/>
                </asp:PlaceHolder>
                <div style="text-align:center; margin:5px 0px;">
                    <asp:Button ID="btnSaveDepartment" runat="server" CssClass="btnSave" 
                        Text="SAVE" ToolTip="Save New Brand" onclick="btnSaveDepartment_Click" />
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlUpdateSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phDepartmentUpdate" runat="server">
                    <forms:Department ID="fDepartment_Update" runat="server" />
                </asp:PlaceHolder>
                ...
                <div style="text-align: center; margin:5px 0px;">
                    <asp:Button ID="btnSaveUpdate" runat="server" CssClass="btnSave" 
                        Text="SAVE" ToolTip="Update Department" onclick="btnSaveUpdate_Click" 
                        Enabled="False" />
                </div>
            </asp:Panel>
