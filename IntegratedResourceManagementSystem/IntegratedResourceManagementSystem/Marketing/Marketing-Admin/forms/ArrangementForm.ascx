<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArrangementForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.ArrangementForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtArrangementDescription" runat="server" Height="40px" 
                       TextMode="MultiLine" CssClass ="modalText"
