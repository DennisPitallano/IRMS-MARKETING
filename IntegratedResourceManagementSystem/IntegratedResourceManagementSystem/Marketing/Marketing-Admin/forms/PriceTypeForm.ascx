<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PriceTypeForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.PriceTypeForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtPriceTypeDescription" CssClass="modalText" runat="server" Height="40px" 
