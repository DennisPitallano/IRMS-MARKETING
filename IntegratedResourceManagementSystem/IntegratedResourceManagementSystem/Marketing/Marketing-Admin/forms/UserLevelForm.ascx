<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserLevelForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.UserLevelForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtUserlevelDescription" CssClass="modalText" runat="server" Height="40px" 
