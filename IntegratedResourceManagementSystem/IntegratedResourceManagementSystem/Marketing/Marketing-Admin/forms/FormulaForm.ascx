<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormulaForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.FormulaForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtFormulaDescription" CssClass="modalText" runat="server" Height="40px" 
