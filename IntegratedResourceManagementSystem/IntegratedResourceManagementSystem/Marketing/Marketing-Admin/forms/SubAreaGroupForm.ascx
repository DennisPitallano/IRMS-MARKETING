<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubAreaGroupForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.SubAreaGroupForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtSubAreaGroupName" CssClass="modalText" runat="server" Height="20px"
                Width ="210px" Font-Size="12px"></asp:TextBox>
        ...
        <td>
            <asp:DropDownList ID="DDLAreaGroup" CssClass="modalText" runat="server" 
                DataSourceID="ObjectDataSource1" DataTextField="GroupName" 
                DataValueField="AreaGroupNo" Font-Size="12px"  Height="22px">
            </asp:DropDownList>   
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                SelectMethod="AreaGroups" 
                TypeName="IRMS.BusinessLogic.Manager.GroupAreaManager">
