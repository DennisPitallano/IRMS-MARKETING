<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TermForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.TermForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtTermName" CssClass="modalText" runat="server" Height="40px" 
                       TextMode="MultiLine"
                Width ="170px" Font-Size="12px"></asp:TextBox>
            <asp:HiddenField ID="hfID" runat="server" Value="0" />
             <asp:HiddenField ID="hfMActionMode" runat="server" Value="NEW" />
        </td>
        <td>
          &nbsp;
        </td>
