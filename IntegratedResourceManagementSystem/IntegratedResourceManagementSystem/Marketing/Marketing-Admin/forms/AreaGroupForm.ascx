<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AreaGroupForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.AreaGroupForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtAreaGroupName" CssClass="modalText" runat="server" Height="20px" 
                       Font-Names="Verdana" ForeColor="#CC6600" 
