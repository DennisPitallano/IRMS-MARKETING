<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.DepartmentForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtDepartmentName" CssClass="modalText" runat="server" Height="40px" 
