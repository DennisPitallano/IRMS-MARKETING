<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompanyForm.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.CompanyForm" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtCompanyName" CssClass="modalText" runat="server" Height="40px" 
                       TextMode="MultiLine" Width ="170px" Font-Size="12px"></asp:TextBox>
            <asp:HiddenField ID="hfID" runat="server" Value="0" />
            <asp:HiddenField ID="hfLogo" runat="server" Value="iserve-logo.png" />
        </td>
        <td>
          &nbsp;
        </td>
