<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustGrp.ascx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.forms.CustGrp" %>
  ...
  <style type ="text/css">
    ...
    <table class ="frmbg" style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtCodeNo" CssClass="modalText" runat="server" Height="20px" 
                        Width ="170px" Font-Size="12px"></asp:TextBox>
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtDesc" CssClass="modalText" runat="server" Height="40px" 
                       TextMode="MultiLine" Width ="170px" Font-Size="12px"></asp:TextBox>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <asp:DropDownList ID="ddbrand" CssClass="modalText" runat="server" Height="22px" 
                     Width ="170px" Font-Size="12px" 
                DataSourceID="SqlDataSource1" DataTextField="BRAND_DESCRIPTION" 
                DataValueField="BRAND_DESCRIPTION"></asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>" 
                SelectCommand="SELECT [BRAND_DESCRIPTION] FROM [BRANDS] ORDER BY [BRAND_DESCRIPTION]">
            </asp:SqlDataSource>
       ...
       <tr>
        ...
        <td>
          <asp:TextBox ID="txtCustomer" CssClass="modalText" runat="server" Height="20px" 
                       Width ="170px" Font-Size="12px"></asp:TextBox>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <asp:TextBox ID="txtSapGroup" CssClass="modalText" runat="server" Height="20px" 
                       Width ="170px" Font-Size="12px"></asp:TextBox>
        </td>
        <td>
