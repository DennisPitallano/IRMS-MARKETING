<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing-Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UserLevelManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.UserLevelManagementPanel" %>
<%@ Register  Src="~/Marketing/Marketing-Admin/controls/AdminMenu.ascx" TagName="menu" TagPrefix="irms" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/Marketing/controls/UCLoader.ascx" TagName="LOADER" TagPrefix="UC" %>
<%@ Register TagPrefix="forms" TagName="UserLevel"  Src="~/Marketing/Marketing-Admin/forms/UserLevelForm.ascx" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/user-level-management.css" rel="stylesheet" type="text/css" />
</asp:Content>
...
<div class="menu_container">
    <irms:menu ID="admin_menu" runat="server" />
        ...
        <div style="height:28px; margin-bottom:10px; line-height:28px; color: #333;text-shadow: 1px 1px 0px white;">
                <asp:Image ID="imgpnlTitle" runat="server" ImageUrl="~/Resources/accounting.png"
                    ImageAlign="Top" Height="28px" />
                &nbsp;<asp:Label ID="Label1" runat="server" Text="USER LEVEL MANAGEMENT PANEL" Font-Bold="True"
        ...
        <ContentTemplate>
            ...
            <div style="height:26px; margin-bottom:1px; " class="modalDrag">
               <div style="float: right;" class="SearchTextContainer">
                SEARCH:
                    <asp:TextBox ID="txtSearch" runat="server" autofocus placeholder="Search User Level" CssClass="modalText" OnTextChanged="txtSearch_TextChanged"
                        AutoPostBack="True" Height="16px" Font-Size="10px" Width="150px" ToolTip="Search User Level"></asp:TextBox>
            ...
            <div class="listContent">
                <div class="titleList">
                <img alt="brands" src="../../Resources/accounting.png" height="16"  align="left" />
                    LIST OF USER LEVEL
                </div>
                <asp:Panel ID="pnlDepartment" runat="server" Width="370px" Height="415px" ScrollBars="Auto">
                    <asp:GridView ID="gvUserLevelList" runat="server" CellPadding="4" 
                        GridLines="None" AutoGenerateColumns="False" CssClass="table_grid"
                       AllowPaging="True"
                        AllowSorting="True" DataKeyNames="ID" DataSourceID="SqlDataSourceUserLevel"
                        EnablePersistedSelection="True" PageSize="13" 
                        onselectedindexchanged="gvUserLevelList_SelectedIndexChanged">
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" Height="16px" ImageUrl="~/Resources/accounting.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:CommandField ShowSelectButton="True" />
                            <asp:BoundField DataField="ID" HeaderText="RECORD #" InsertVisible="False"
                                ReadOnly="True" SortExpression="ID"></asp:BoundField>
                            <asp:BoundField DataField="ListDesc" HeaderText="USER LEVEL DESCRIPTION" SortExpression="ListDesc">
                            </asp:BoundField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceUserLevel" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                        SelectCommand="SELECT [ID], [ListDesc] FROM [lstUserLevel] ORDER BY [ID] DESC">
                    </asp:SqlDataSource>
                </asp:Panel>
            </div>
            ...
            <asp:Panel ID="pnlNewSizeModal" runat="server" CssClass="modal">
                <asp:Panel ID="pnlNewSizeModalDrag" runat="server" CssClass="modalDrag">
                    ...
                    <div class="sizeLogo">
                        <img alt="new brand" src="../../Resources/accounting.png" height="16" align="top" />
                        NEW USER LEVEL
                    </div>
                </asp:Panel>
                <asp:PlaceHolder ID="phUserLevelForm" runat="server">
                    <forms:UserLevel ID="fUserLevel" runat="server"/>
                </asp:PlaceHolder>
            ...
            <asp:Panel ID="pnlUpdateSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phUserLevelUpdate" runat="server">
                    <forms:UserLevel ID="fUserLevel_Update" runat="server" />
                </asp:PlaceHolder>
                ...
                <div style="text-align: center; margin:5px 0px;">
                    <asp:Button ID="btnSaveUpdate" runat="server" CssClass="btnSave" 
                        Text="SAVE" ToolTip="Update User Level" 
            ...
            <asp:Panel ID="pnlDeleteModal" runat="server" CssClass="modal">
                ...
                <div style="border: 1px solid #FFCC66; text-align:center; font-family:Verdana; font-size:12px; height:23px;
                    ...
                    <div style="text-align:center; color: #FFFF99; font-family:Verdana; font-size:11px; margin:5px 2px;">
                        <asp:Label ID="lblUserLevelToDelete" runat="server" Text="No data to delete. Select from the list and try again."></asp:Label>
                    </div>
                <div style=" text-align:center; margin: 5px 0px;">
