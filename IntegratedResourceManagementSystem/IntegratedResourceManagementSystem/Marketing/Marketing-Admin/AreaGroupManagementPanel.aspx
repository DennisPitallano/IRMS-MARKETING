<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing-Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AreaGroupManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.AreaGroupManagementPanel" %>
<%@ Register  Src="~/Marketing/Marketing-Admin/controls/AdminMenu.ascx" TagName="menu" TagPrefix="irms" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="~/Marketing/controls/UCLoader.ascx" TagName="LOADER" TagPrefix="UC" %>
<%@ Register TagPrefix="forms" TagName="PriceType"  Src="~/Marketing/Marketing-Admin/forms/PriceTypeForm.ascx" %>
<%@ Register TagPrefix="forms" TagName="AreaGroup"  Src="~/Marketing/Marketing-Admin/forms/AreaGroupForm.ascx" %>
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/area-group-management.css" rel="stylesheet" type="text/css" />
</asp:Content>
...
<div class="menu_container">
    <irms:menu ID="admin_menu" runat="server" />
        ...
        <div style="height:28px; margin-bottom:10px; line-height:28px; color: #333;text-shadow: 1px 1px 0px white;">
                ...
                &nbsp;<asp:Label ID="Label1" runat="server" Text="AREA GROUP MANAGEMENT PANEL" Font-Bold="True"
        ...
        <ContentTemplate>
            ...
            <div style="height:26px; margin-bottom:1px; " class="modalDrag">
               <div style="float: right;" class="SearchTextContainer">
                SEARCH:
                    <asp:TextBox ID="txtSearch" runat="server" autofocus placeholder="Search Area Group" CssClass="modalText" OnTextChanged="txtSearch_TextChanged"
                        AutoPostBack="True" Height="16px" Font-Size="10px" Width="150px" ToolTip="Search Area Group"></asp:TextBox>
                ...
                <div style="float: left;">
                    ...
                    <div style="float: left; margin-right: 5px;">
                       <a style="text-decoration:none;" href="Reports/AreaGroup.aspx" target="_blank" >
            ...
            <div class="listContent">
                ...
                <asp:Panel ID="pnlDepartment" runat="server" Width="450px" Height="415px" ScrollBars="Auto">
                    <asp:GridView ID="gvAreaGroupList" runat="server" CellPadding="4" 
                        GridLines="None" AutoGenerateColumns="False" CssClass="table_grid"
                       AllowPaging="True"
                        AllowSorting="True" DataKeyNames="AGNo" DataSourceID="SqlDataSourceAreaGroup"
                        EnablePersistedSelection="True" PageSize="15" 
                        onselectedindexchanged="gvAreaGroupList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="AGNo" HeaderText="RECORD #" InsertVisible="False"
                                ReadOnly="True" SortExpression="AGNo"></asp:BoundField>
                            <asp:BoundField DataField="GroupName" HeaderText="AREA GROUP NAME" SortExpression="GroupName">
                            </asp:BoundField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceAreaGroup" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                        SelectCommand="SELECT [AGNo], [GroupName] FROM [GrpArea] ORDER BY [AGNo] DESC">
                    </asp:SqlDataSource>
                </asp:Panel>
            </div>
            ...
            <asp:Panel ID="pnlNewSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phAreaGroupForm" runat="server">
                    <forms:AreaGroup ID="fAreaGroup" runat="server"/>
                </asp:PlaceHolder>
                <div style="text-align:center; margin:5px 0px;">
                    <asp:Button ID="btnSave" runat="server" CssClass="btnSave" 
                        Text="SAVE" ToolTip="Save New Area Group" onclick="btnSave_Click" />
                </div>
            </asp:Panel>
            <asp:Panel ID="pnlUpdateSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phAreaGroupUpdate" runat="server">
                    <forms:AreaGroup ID="fAreaGroup_Update" runat="server" />
                </asp:PlaceHolder>
            ...
            <asp:Panel ID="pnlDeleteModal" runat="server" CssClass="modal">
                ...
                <div style="border: 1px solid #FFCC66; text-align:center; font-family:Verdana; font-size:12px; height:23px;
                    ...
                    <div style="text-align:center; color: #FFFF99; font-family:Verdana; font-size:11px; margin:5px 2px;">
                        <asp:Label ID="lblAreaGroupToDelete" runat="server" Text="No data to delete. Select from the list and try again."></asp:Label>
                    </div>
                <div style=" text-align:center; margin: 5px 0px;">
