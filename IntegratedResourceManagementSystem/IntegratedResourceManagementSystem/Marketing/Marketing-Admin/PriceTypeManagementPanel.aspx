<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing-Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PriceTypeManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.Marketing_Admin.PriceTypeManagementPanel" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/price-type-management.css" rel="stylesheet" type="text/css" />
</asp:Content>
...
<div class="menu_container">
    <irms:menu ID="admin_menu" runat="server" />
        ...
        <div style="height:28px; margin-bottom:10px; line-height:28px; color: #333;text-shadow: 1px 1px 0px white;">
                ...
                &nbsp;<asp:Label ID="Label1" runat="server" Text="PRICE TYPE MANAGEMENT PANEL" Font-Bold="True"
    ...
    <asp:UpdatePanel ID="upnlBrands" runat="server">
        <ContentTemplate>
            ...
            <div style="height:26px; margin-bottom:1px; " class="modalDrag">
                ...
                SEARCH:
                    <asp:TextBox ID="txtSearch" runat="server" autofocus placeholder="Search Price Type" CssClass="modalText" OnTextChanged="txtSearch_TextChanged"
                        AutoPostBack="True" Height="16px" Font-Size="10px" Width="150px" ToolTip="Search Price Type"></asp:TextBox>
            ...
            <div class="listContent">
                ...
                <asp:Panel ID="pnlDepartment" runat="server" Width="370px" Height="415px" ScrollBars="Auto">
                    <asp:GridView ID="gvPriceTypeList" runat="server" CellPadding="4" 
                        GridLines="None" AutoGenerateColumns="False" CssClass="table_grid"
                       AllowPaging="True"
                        AllowSorting="True" DataKeyNames="ID" DataSourceID="SqlDataSourcePriceType"
                        EnablePersistedSelection="True" PageSize="15" 
                        onselectedindexchanged="gvPriceTypeList_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ListDesc" HeaderText="PRICE TYPE DESCRIPTION" SortExpression="ListDesc">
                            </asp:BoundField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourcePriceType" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                        SelectCommand="SELECT [ID], [ListDesc] FROM [lstPriceType] ORDER BY [ID] DESC">
                    </asp:SqlDataSource>
                </asp:Panel>
            </div>
            ...
            <asp:Panel ID="pnlNewSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phPriceTypeForm" runat="server">
                    <forms:PriceType ID="fPriceType" runat="server"/>
                </asp:PlaceHolder>
                <div style="text-align:center; margin:5px 0px;">
                    <asp:Button ID="btnSave" runat="server" CssClass="btnSave" 
                        Text="SAVE" ToolTip="Save New Price Type" onclick="btnSave_Click" />
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlUpdateSizeModal" runat="server" CssClass="modal">
                ...
                <asp:PlaceHolder ID="phPriceTypeUpdate" runat="server">
                    <forms:PriceType ID="fPriceType_Update" runat="server" />
                </asp:PlaceHolder>
                ...
                <div style="text-align: center; margin:5px 0px;">
                    <asp:Button ID="btnSaveUpdate" runat="server" CssClass="btnSave" 
                        Text="SAVE" ToolTip="Update Price Type" onclick="btnSaveUpdate_Click" 
                        Enabled="False" />
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlDeleteModal" runat="server" CssClass="modal">
                ...
                <div style="border: 1px solid #FFCC66; text-align:center; font-family:Verdana; font-size:12px; height:23px;
                    ...
                    <div style="text-align:center; color: #FFFF99; font-family:Verdana; font-size:11px; margin:5px 2px;">
                        <asp:Label ID="lblPriceTypeToDelete" runat="server" Text="No data to delete. Select from the list and try again."></asp:Label>
                    </div>
                <div style=" text-align:center; margin: 5px 0px;">
