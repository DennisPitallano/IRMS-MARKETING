<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true" CodeBehind="BranchDepartmentCodeManagementPanel.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.BranchDepartmentCodeManagementPanel" %>
            ...
            <ContentTemplate>
                <div style="height: 26px; margin-bottom: 1px;" class="modalDrag">
                    <div style="float: right;" class="SearchTextContainer">
                        SEARCH:
                        <asp:TextBox ID="txtSearch" runat="server" autofocus placeholder="Search Branch Department Code"
                            CssClass="modalText" AutoPostBack="True" Height="16px" Font-Size="10px" Width="150px"
                            ToolTip="Search Branch Department Code" 
                    ...
                    <div style="float: left;">
                        <div style="float: left; margin-right: 5px;">
                            ...
                            <asp:ModalPopupExtender ID="btnNew_ModalPopupExtender" runat="server" 
                                CancelControlID="btnCancelCreateBranchDepartmentCode" DynamicServicePath="" 
                                Enabled="True" PopupControlID="pnlCreateBranchDeptCodeModal" 
                                PopupDragHandleControlID="pnlCreateBranchDeptCodeModalDrag" 
                                TargetControlID="btnNew" BackgroundCssClass="bgModal">
                        ...
                        <div style="float: left; margin-right: 5px;">
                            ...
                            <asp:ModalPopupExtender ID="btnUpdate_ModalPopupExtender" runat="server" 
                                CancelControlID="btnCancelUpdate" DynamicServicePath="" Enabled="True" 
                                PopupControlID="pnlUpdateBranchDepartmentCodeModal" 
                                PopupDragHandleControlID="pnlUpdateBranchDepartmentCodeModalDrag" 
                                TargetControlID="btnUpdate" BackgroundCssClass="bgModal">
                            </asp:ModalPopupExtender>
                        </div>
                        <div style="float: left; margin-right: 5px;">
                ...
                LIST OF BRAND DEPARTMENT CODES
                    ...
                    <asp:GridView ID="gvBrandDepartmentCode" CssClass="table_grid" runat="server" CellPadding="4" 
                        ...
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="RECORD_NUMBER" 
                        DataSourceID="SqlDataSourceBranchDepartmentCodes" 
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Image ID="imgBranchDepartmentCode" runat="server" ImageUrl="~/Resources/code-icon.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceBranchDepartmentCodes" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>" 
                        SelectCommand="SELECT * FROM [BRANCH_DEPT_CODES] ORDER BY RECORD_NUMBER DESC"></asp:SqlDataSource>
                </div>
                <%--Delete Modal--%>
                <asp:Panel ID="pnlDeleteModal" runat="server" CssClass="modal">
                    ...
                    <div style="text-align: center; margin:5px;">
                        <asp:Label CssClass="modalLabel" ID="lblBranchDepartmentCodeToDelete" runat="server" Text="No data to delete. Select from the list and try again."></asp:Label>
                    </div>
                ...
                <asp:Panel ID="pnlCreateBranchDeptCodeModal" CssClass="modal" runat="server">
                    ...
                    <div class="modalLabel" style="text-align: center; padding: 10px 10px 0px 10px; font-size: 1em;">
                        BRANCH:<asp:DropDownList ID="DDLBranches" Height="22px" CssClass="modalText" runat="server">
                        </asp:DropDownList>
                    </div>
                    <div class="modalLabel" style="text-align: center; padding: 10px; font-size: 1em;">
                        CODE:<asp:TextBox ID="txtBranchDepartmentCode" Width="100px" CssClass="modalText"
                            Height="22px" runat="server"></asp:TextBox>
                    </div>
                    <div style="text-align: center; margin: 5px;">
                        <asp:Button ID="btnSaveBranchDepartmentCode" runat="server" Text="CREATE" CssClass="btnSave"
                            Width="75px" onclick="btnSaveBranchDepartmentCode_Click" />
                ...
                <asp:Panel ID="pnlUpdateBranchDepartmentCodeModal" CssClass="modal" runat="server">
                    ...
                    <div class="modalLabel" style="text-align: center; padding: 10px 10px 0px 10px; font-size: 1em;">
                        BRANCH:<asp:DropDownList ID="DDLBranchesUpdate" Height="22px" CssClass="modalText" runat="server">
                        </asp:DropDownList>
                    </div>
                    <div class="modalLabel" style="text-align: center; padding: 10px; font-size: 1em;">
                        CODE:<asp:TextBox ID="txtBranchDeptCodeToUpdate" Width="100px" CssClass="modalText"
                            Height="22px" runat="server"></asp:TextBox>
                    </div>
                    <div style="text-align: center; margin: 5px;">
                        <asp:Button ID="btnSaveUpdate" runat="server" Text="UPDATE" CssClass="btnSave" 
                            Width="75px" onclick="btnSaveUpdate_Click"
                            />
