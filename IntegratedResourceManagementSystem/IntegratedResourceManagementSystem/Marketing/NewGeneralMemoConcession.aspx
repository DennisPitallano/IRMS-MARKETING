<%@ Page Title="" Language="C#" MasterPageFile="~/Marketing/Marketing.Master" AutoEventWireup="true"
    CodeBehind="NewGeneralMemoConcession.aspx.cs" Inherits="IntegratedResourceManagementSystem.Marketing.NewGeneralMemoConcession" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="height: 22px; margin-bottom: 10px; line-height: 22px; font-family: Verdana;
     ...
     <%--                    <asp:DropDownList CssClass="modalText" Height="20px" ID="DDLBrand" Font-Size="11px"
                        ...
                        DataValueField="BrandDescription" AutoPostBack="True" onselectedindexchanged="DDLBrand_SelectedIndexChanged" 
                        >
                    </asp:DropDownList>--%>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList CssClass="modalText" Height="20px" ID="DDLBrand" Font-Size="11px"
                        runat="server" AutoPostBack="True" onselectedindexchanged="DDLBrand_SelectedIndexChanged" 
                        >
                    </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DDLAreaGroup" Height="20px" CssClass="modalText" runat="server"
                                    AutoPostBack="True" 
                                    OnSelectedIndexChanged="DDLAreaGroup_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="frmLabel">
                                <asp:Label ID="lblSubArea" AssociatedControlID="DDLSubArea" runat="server" 
                ...
                <asp:View ID="vCustomer" runat="server">
                    ...
                    <div style="display: inline-block; margin-right: 5px; margin-top: 4px;">
                        <asp:Button ID="btnBrowseCustomer" runat="server" Text="browse.." CssClass="btnBrowse"
                            Font-Names="Verdana" onclick="btnBrowseCustomer_Click" />
                    ...
                    <label class="frmLabel" for="MainContent_txtPromoPeriodFromCustomer">
                        ...
                        <asp:CalendarExtender ID="txtPromoPeriodFromCustomer_CalendarExtender" runat="server"
                            Enabled="True" TargetControlID="txtPromoPeriodFromCustomer">
                        </asp:CalendarExtender>
                    </label>
                    <label class="frmLabel" for="MainContent_txtPromoPeriodToCustomer">
                        ...
                        <asp:CalendarExtender ID="txtPromoPeriodToCustomer_CalendarExtender" runat="server"
                            Enabled="True" TargetControlID="txtPromoPeriodToCustomer">
                        </asp:CalendarExtender>
                    </label>
                    <br />
                        ...
                        <div style="padding: 3px 5px;">
                            <asp:GridView ID="gvCustomers" runat="server" CellPadding="4" CssClass="table_grid"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CustNo" HeaderText="CUST NO" InsertVisible="False" ReadOnly="True"
    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td>                    
                    <asp:TextBox ID="txtMemoNo" CssClass="modalText" Height="20px" runat="server" 
                        ReadOnly="True"></asp:TextBox>
                    <asp:TextBox ID="txtMemoNumber" CssClass="modalText" Height="20px" 
                        runat="server" Visible="False"></asp:TextBox>&nbsp
                    ...
                    <asp:Panel ID="pnlCustomersModal" runat="server" CssClass="modal">
                        ...
                        <div style="padding: 3px 5px;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceCustomers" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                                ...
                                SelectCommand="SELECT [CustNo], [CompName] FROM [CustInfo] where Brand= @brand">
                                <SelectParameters>
...
<%--                <asp:Button ID="btnAddMemo" runat="server" Text="ADD MEMO" CssClass="btnNew" />
            ...
            <div style="float: left; display: inline-block; margin-right: 5px;">
                ...
                <asp:ModalPopupExtender ID="btnAddNewItem_ModalPopupExtender" runat="server" CancelControlID="btnSelectItemNo"
                    DynamicServicePath="" Enabled="True" PopupControlID="pnlNewItemModal" PopupDragHandleControlID="pnlNewItemModalDrag" TargetControlID="hfDuplicateStyle">
                </asp:ModalPopupExtender>
...
<%--            <strong>NEW MARKDOWN
            ...
            <div style="display: inline-block; margin-left: 5px;">
                <asp:Button ID="btnRemoveItem" runat="server" Text="REMOVE ITEM/S" 
                    CssClass="btnDelete" onclick="btnRemoveItem_ClickEx" />
            </div>
        </div>
        ...
        <div>
            ...
            <asp:GridView ID="gvNewMarkdown" runat="server" CellPadding="4"
        ...
        <asp:Panel ID="pnlNewItemModal" runat="server" CssClass="modal">
            ...
            <div style="margin: 3px 3px;">
                <asp:GridView ID="gvItems" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    onpageindexchanged="gvItems_PageIndexChanged" EnableViewState="False">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:CommandField ShowSelectButton="True" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceItems" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                    ...
                    EnableCaching="True">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DDLBrand" Name="BrandName" PropertyName="SelectedItem.Text"
                            Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <br />
            ...
            <div style="text-align: center; margin: 5px 0px;">
                <asp:Button ID="btnSelectItemOk" runat="server" Text="OK" CssClass="modalWarningButtonYes"
                    ToolTip="OK" onclick="btnSelectItemOk_ClickEx"/> &nbsp
...
<%--                    <label class="frmLabel" for="MainContent_rdioStatus">
    ...
    <div style="text-align: center;">
        <div style="display: inline-block; margin-left: 5px;">
            <asp:Button ID="btnSaveGeneralMemo" runat="server" Text="SAVE" 
                CssClass="btnSave" onclick="btnSaveGeneralMemo_ClickEx" />
        </div>
        <div style="display: inline-block; margin-left: 5px;">
    ...
    <asp:Panel ID="pnlAddMEmo" runat="server" CssClass="modal">
                        ...
                        <div style="padding: 2px 2px; height: 28px;">
                            <div class="SearchTextContainer">
                                ...
                                <asp:TextBox ID="txtAddMemoSearch" Height="16px" Font-Size="10px" Width="120px"
                                    placeholder="Search General Memo" CssClass="modalText" runat="server" 
                                    ontextchanged="txtAddMemoSearch_TextChanged"></asp:TextBox>
                                <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/Resources/search.png"
                                    ImageAlign="AbsBottom" onclick="btnSearch_Click" />
                            </div>
                        </div>
                        <div style="padding: 3px 5px;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceAddMemo" runat="server" ConnectionString="<%$ ConnectionStrings:IRMSConnectionString %>"
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="DDLBrand" Name="BrandName" 
                        ...
                        <div style="text-align: center; padding: 3px 0;">
                            <asp:Button ID="btnAddMemoOk" CssClass="modalWarningButtonYes" runat="server"
                                Text="OK" ToolTip="Currently Disabled, please select from list." onclick="btnAddMemoOk_ClickEx"
                                />
             ...
             <asp:Panel ID="pnlMemoNoNotifier" runat="server" CssClass="modal" >
                ...
                <div style="text-align:center; color: black; font-family:Verdana; font-size:11px; margin:5px 2px;">
                        <asp:Label ID="lblNewMemoNo" runat="server" Text="New Markdown Memo Saved ({0})!"></asp:Label>
                </div>
                <div style="text-align:center;">
                </div>
                <div style=" text-align:center; margin: 5px 0px;">
