...
{
    public partial class MINDANAODRSummaryPrintPreview : System.Web.UI.Page
    {
        ...
        private void InitializeReport()
        {
            ...
            string reportCacheKey = string.Concat("MINDANAOCDISummary", year, month, Request.QueryString["Brand"],DRStatus);
            ...
            switch (days_count)
            {
                case 30:
                    ...
                    {
                        REPORT_DOC = (RptCDISummaryMINDANAO30)Cache[reportCacheKey];
                    }
                    else
                    {
                        REPORT_DOC = new RptCDISummaryMINDANAO30();
                ...
                case 31:
                    if (Cache[reportCacheKey] != null)
                    {
                        REPORT_DOC = (RptCDISummaryMINDANAO31)Cache[reportCacheKey];
                    }
                    else
                    {
                        REPORT_DOC = new RptCDISummaryMINDANAO31();
                        Cache.Insert(reportCacheKey, REPORT_DOC);
                    }
                    break;
                case 28:
                    if (Cache[reportCacheKey] != null)
                    {
                        REPORT_DOC = (RptCDISummaryMINDANAO28)Cache[reportCacheKey];
                    }
                    else
                    {
                        REPORT_DOC = new RptCDISummaryMINDANAO28();
                        Cache.Insert(reportCacheKey, REPORT_DOC);
                    }
                    break;
                case 29:
                    if (Cache[reportCacheKey] != null)
                    {
                        REPORT_DOC = (RptCDISummaryMINDANAO29)Cache[reportCacheKey];
                    }
                    else
                    {
                        REPORT_DOC = new RptCDISummaryMINDANAO29();
                        Cache.Insert(reportCacheKey, REPORT_DOC);
                    }
                    break;
                default:
            ...
            this.MINDANAODRSummaryReport.ParameterFieldInfo = prmList;
            MINDANAODRSummaryReport.ReportSource = REPORT_DOC;
        }
