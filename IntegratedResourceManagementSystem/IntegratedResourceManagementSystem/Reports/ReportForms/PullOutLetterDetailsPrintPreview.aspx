...
<head runat="server">
    ...
    <style type="text/css">
        #gvBoxContainerDetails, #gvContainers
        {
            font-family: Arial;
            font-size: 10px;
        }
...
<body>
    ...
    <div id="dBoxes" style="float: left;">
    ...
    <div style="float: left; margin-left: 10px;">
        ...
        <asp:GridView ID="gvBoxContainerDetails" CssClass="table_grid" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ContainerNumber" HeaderText="Container #" 
                ...
                <asp:BoundField DataField="SRP" DataFormatString="{0:###,###.##}" 
